...
//ggg
// tape('Spilt a string into an array of its words', function(t) {
//     let actual = separateSnippet(snippet);
//     let expected = ["and", "I", "think", "it's", "gonna", "be", "a", "long", "long", "time"];
//   t.deepequals(actual, expected, "Should be an array of string words");
//   t.end();
// });